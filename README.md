...
|---|---|---|---|
| 01 | `notebooks/01_fMRI_pipeline_ABIDE_I_II.ipynb` | fMRI preprocessing → PyG graphs | ~3-4h |
| 02 | `notebooks/02_MEG_pipeline_OpenNeuro_ds005234.ipynb` | MEG preprocessing → feature tensors | ~2-3h |
